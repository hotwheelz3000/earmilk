...
r’moves?|rebuilds?|slingshots?|lights?\s+up|re-thinks?|’
r’captures?|crafts?|creates?|blends?|fuses?|mixes?|’
r’collaborates?|partners?|joins?|teams?’
)

def extract_artist_song(headline):
# Pattern 1: “Song” is … Artist at/in …
...
```
# Pattern 2: Artist's "Song" (smart or regular apostrophe)
...
# Use first smart-quoted string as song title
